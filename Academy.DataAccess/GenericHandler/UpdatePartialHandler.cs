...
/// <summary>
/// Update a partial portion of a document
/// </summary>
/// <typeparam name="T"></typeparam>
public class UpdatePartialHandler<T>: IActionCommand<T>
{
    #region Variable
    ...
    public async Task<T> CommandHandlerAsync(
        FilterDefinition<T> filter, 
        UpdateDefinition<T> update, T model)
    {
        T actionModel = model;
        try
        {
        ...
        catch (Exception ex)
        {
            ...
            _logger.LogError(
                "{ModelType}:UpdatePartial Command Handler {Error} {Data}", model.GetType().Name, ex, model.ToJson());
        }
        return actionModel;
    }
